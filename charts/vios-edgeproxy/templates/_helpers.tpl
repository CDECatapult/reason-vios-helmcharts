...
*/}}
{{- define "edgeproxy.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "edgeproxy.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
We truncate at 63 chars because some Kubernetes name fields are limited to this (by the DNS naming spec).
*/}}
{{- define "edgeproxy.postgresql.fullname" -}}
...
*/}}
{{- define "edgeproxy.imagePullSecrets" -}}
