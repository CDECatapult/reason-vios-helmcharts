...
Common labels
*/}}
{{- define "servicebroker.labels" -}}
helm.sh/chart: {{ include "servicebroker.chart" . }}
{{ include "servicebroker.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "servicebroker.selectorLabels" -}}
app.kubernetes.io/name: {{ include "servicebroker.name" . }}
...
*/}}
{{- define "servicebroker.serviceAccountName" -}}
{{- if .Values.django.serviceAccount.create }}
{{- default (include "servicebroker.fullname" .) .Values.django.serviceAccount.name }}
{{- else }}
...
We truncate at 63 chars because some Kubernetes name fields are limited to this (by the DNS naming spec).
*/}}
{{- define "servicebroker.postgresql.fullname" -}}
...
*/}}
{{- define "servicebroker.imagePullSecrets" -}}
